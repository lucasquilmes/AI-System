"""Heatmap Flesch Reading Ease — modelo x técnica."""
import pandas as pd
...
pivot = df.pivot_table(
    values="flesch_generado_promedio",
    index="modelo",
    columns="version",
    aggfunc="mean"
).round(2)
...
sns.heatmap(
    ...
    vmax=60,
    ax=ax,
    cbar_kws={"label": "Flesch Reading Ease"},
)
ax.set_title(
    "Flesch Reading Ease — Media por modelo y técnica\n"
    "(mayor = más legible; objetivo Lectura Fácil: 65–75)",
    fontsize=13, pad=12
)
...
plt.tight_layout()
out = OUTPUT_DIR / "heatmap_flesch.png"
